...
```text
Ifroa-10337-10074 | 2025 RELEASE UNDER THE PRESIDENT JOHN F. KENNEDY ASSASSINATION RECORDS ACT OF 1992 |
...
crash basis using overtime employees and resulted ina
...
_ processing resources well beyond what would be considered
...
_by the Board to postpone what was generally considered
...
_ There are a number of basic lessons from the JFK review
...
* Develop a strategy/policy with the IROs concerning the
reléase of information. Be smart about it; do not accept
stonewalling by them on relevant information that can be
released. At the same time, avoid confrontations with them
on marginal or non-relevant information.
...
DRAFT: Section 271, ARRB Requests for Additional
...
all began as a request by the Board or an ARRB staff méinber
...
Ly. The Agency’s written responses to each request -
...
project.
Se. Lessons learned: A number of things syrfaced as
...
authority) are met; and, a senior focal point officexy who
...
declassified version of the file was releasedin 1998.
...
was reviewed and released in 1994. The ARRB requested that the original fi file be
...
The survey undertaken in response to Executive Order HHH located seven
...
history of this effort (S years), CIA, as did other agencies, developed (and
...
¢ Treat documents in ways different from all other release programs. at de d met baal theg halt

¢ Postpone plans for systematic declassification on other programs forsiticieWetssne legal
mandate.
...
I was asked because: a) for seven-plus years I've been_
...
_ experience reiterates is the need for a proactive, not just
...
AIUO When Separated CL BY: 0611637. if
from Attachments CL REASON: 1.5(d)
DECL ON: x5
...
that a senior-level panel be established to consider an_
...
s:/oim/fo/jim/hrp/jf£k/C.B. JFK Declass Exp.doc
...
Regulations.’ The Act presumed release. It did allow for _
...
-) See ‘OGC-92-5325, 14 Dec 92 and OGC-94-52916, 19 Sep 94 (Attachment B)

AIUO When Separated ch py: — (0611637/
from Attachments . CL REASON: ~ 1.5 (d)
DECL ON: x5
...
both on postponement and on relevance, subject only toa
...
NARA-required Research Identification Forms, resulted ina
...
in full or with ‘rédactions, the documents went to a DO review
...
e Use retirees with broad Agency experience under staff
...
e Develop and keep updating written guidelines, including
those for coordinating third-agency documents

e Establish early what is already in the public domain. .
...
e Avoid confrontation -on marginal or non-relevant
information. Avoid stonewalling on relevant information.

e Because the Information Review Officers are the key
...
_ to make “significant historical information available without
13-00000
...
SUBJECT: The JFK Déclassification Experience

been co-opted. Both the DO team and HRG were seen, at times,
...
28. (U) If this experience leads to a serious
...
tiveness of both the FOIA and _ the
...
sure.” Second, the FOIA provides broad-
...
closure." Third, the FOIA does not apply to
unpublished Congressional records.” Con-
...
enumerated categories of harm. As many se
...
outweigh any public benefit in the disclo- _
...
sumption of immediate disclosure.” The statute
...
full release.” The legislative history of the
...
Kennedy.”” The Review Board interpreted
...
a. Segregability and substitute language.
...
SSINATION RECORDS REVIEW BOARD
...
eral investigation of the assassination.”
...
term.” The Act requires government agencies
...
The FBI's ‘s “core and related” files consist of
those récords that the FBI gathered in
...
Commission files andghe JFK assassination
investigation file. The’“related” files include
FBI files on Lee“Harvéy Oswald’s wife
Marina and mother Marguerite, Oswald’s
friend Georgé DeMohrenschildt, and the
Oswalds’ Dallas friends Ruth‘ ‘and Michael
Paine. The FBI began its processing of the
core and related files in 1993. Theg Review
Boafd applied strict standards to its review of
postponements i in the core and related files.
...
guidelines (explained below) to thé HSCA
subject files.
...
CHarrTer 5: THE STANDARDS FOR R VIEW: Review

e. FBI records on the congressional commit-
_ tees that investigated the assassination.
...
sentation and in a “position paper.” The FBI's _.
...
Office, and ultimately the Department of
...
CHAPTER 5: THE STANDARDS FOR REVIE|
...
_tian’s perspective, are not closely related to
...
marginally relevant records, but would not
...
sure of thé assassination record is of such
...
ti, Commentary. Names of numerous CIA
...
The CIA, however, was reluctant to produce
...
Board designated oné day of their meeting
...
large number of CIA officer names in the CLA
records, the Review Board determined thaf it
...
ii. Commentary. The CLA employee who
...
clashed with the CIA's strong evidence in
...
ousy SINGH O'NEAL. SLASSIFIED MESSE |

wet C/GUSIG °° ie ererrT’
or 3 $367 Q 0 noe E -
nxt 323 NOY 63 DHE BH CE LE HO,

1 MEXICO CITY tiny

Feomr DIRECTOR

) Cifors, CI/IG 2, Fl, SRT, WH Ty

IMMEDI A HISTORICAL REVIEW PROGRAT
urna e  RELEASE As stan

cour: Cl/St
wero «Oct, D/oct, OOP, ADD
wane
...
. i
1, IMPORTANT YOU REVIEW ALU LIENVOY TAPES AND

saanscniPTejsNcE 27 SEPTEMBER T0 LOCATE ALL MATERIAL
...
3 fer ORIGINAL TAPES avananiz? | TASER OATIOA FvCOM
16 APR 3876
\COMDUCTED ©
END OF MESSAGE [Gams anne

CS Comment: *Reported that on 1 October 63, an American mate who satd
hie vame wae Leo Oswald was at the Soviet Embassy in Mexico City,

sonnet nee O-54) » Porasvaty
\ mn : Reb F=4FtH
D:a60-5-4 oF teint MR NS TUG

.
— Stony Scedso
REPRODUCTION BY OTHER THAN THE ISSUING OFFICE I$ PROMIBITED. Coo Ma,
...
i. Review Board guidelines. The Review
Board protected the names of all National
...
teleased the information, the Review Board
...
Review Board required the CIA to provide
...
ts in the collection and the most relevant
...
ever, release the  slugline “RYBAT
GPFLOOR.” CIA offered no substantive
arguments to support its request for post-
poncment of the slugline. Given the statute’s
...
telease CIA sluglines.

+ CLA surveillance methods.

i. Review Board guidelines. The Review
Board generally released CIA surveillance
mcthods, the details of their implementation,
...
Kage “surveillance method,” “operational
details,” or “sensitive operation.”

ti, Commentary. As with all its sources
nd methods, CIA initially requested the
...
oF anton ‘3 SHOULD CO NEXT EVEN THOUGH ALVARADO HAY BE
TH MEXICAN HANDS. | ASSUNE ME CAN BE USED AS CONSULTANT AT LEAST,
...
THAT WE WELL KNOW WHITHER KE CAN ARD SHOULD CONTACT MEXICAN AUTHORITIES,
AND THAT WOXE WILL CLEAR ANY ACTIGE USE VE MAKE OF HIN WITH THE
DENY REP. ODIWY HERE KMOWS ME IS COMIC TO KEXT TO UELPe

Qe AT 1830 WASHINGTON TIME, WHICH I$ ABOUT 1630 TOUR FINE, WE HAVE

Wo FURTHER REVS OR REQUESTS nea
...
Record reviewed unttaterally by CIA fn 1992.

WH IMLAY + Sean

SUIECT: Meter im eendize the fi: cable stout
Siro

Atte nee seute nave ben rope cod an Geb
speiaican' pe Set at He RIES FBR

an, 3 sare of te or
i tog a pigeen % Se aktter se ‘teas, i or

‘s2eROeED FHS REESE LEE
AMSTEL ISAO PEGE

rapa “tte

Board generally released the location of all
...
SETHET: “eller Un contig he fine catde «
fe de tout

keiey foster. ey i gue tae Cees “an at?
deve A Shiga ots
Toe te Sigs eacy
Kren tadicate ae Toes
ian trav cripy for
Ne Tien pee chee, St pares oe
ie'de Bustin iba trans erfter's Ge ied sees ‘cota
...
routd have
Later wi
bet af aun thee “ean wee
rattan caxpheted hha nich
...
ti. Commentary. Initially, the Review .
...
ti. Commentary. Once the Review Board
...
CnarpTeR ‘5: THE STANDARDS FOR REVIEW: REVIEW Boarp'COMMON Law
...
i. Review Board guidelines. CLA organizes
...
i, Review Board guidelines. CLA employ-
...
ti, Commentary. The CIA argued that it
...
li. Commentary. The Review Beard vigor-
...
individual who has provided or is currently
...
tng with other United States citizens was gener-
...
Hence activities against Communist Bloc
...
u. Commentary and overview of foreign
counterintelligence appeals. The FBI's assassi-

_dence on the foreign
...
VIA: W. George James
Associate Genel unsel
Litigation Divisigh, OGC
...
Geliberations, law enforcement information of the
...
Gecisions of the Assassination Records Board. We can expect,
...
PREP PRP PPB Pe EPP PPR
:
ASENCY- iNTERNAL USE ONLY
PRIVILEGED ATTORNEY WORK PROC UCT
...
44 U.S.C. § 2107 note. For ycur convenience, I have highiightred
the pertinent provisions that will aid in ressonding to an
...
that may be protected and set a strict procedsral scheme by which
...
AGENCY-INTERNAL USE ONLY
PRIVILEGED ATTORNEY WORK PRODVCT
...
Directorate of Operations and other appropriaze Agency
...
7(i) (1). Specifically, the “Review Soard shall consider and
...
S. If the Review Board determines to order the disclosure
...
early years of the project (1992-1994), with the concurrence of the DO/IRO, but OIM has no _
...
and among EA/PAMSI, OGC, and others and queries to the Australian desk, and, in turn, the Station and
...
3. (S) Cables exchanged between Headquarters and Canberra over the issue in-Item-l-were

. declared assassination records, but release of the Cables was postponed unt postponed until 2017.
SECRET
LIA 2-82
x5
...
2. (S) Another British document in the collection provided information that as of 1982

i “KOSTIKOV . . . was posted in Beirut in 1978 . . . and may still be there.” (The author EPSTEIN in

\ Legend claims KOSTIKOV was Lee Harvey Oswald’s KGB case officer in Mexico City.) The British desk
a4 accepted the release of the one pertinent paragraph (one of five paragraphs in the document), and the Board
agreed to postpone until 2017 the release of all other text and source originating information.

3. (S) The BOARD learned of the existence of a British document that the CIA possessed from the
...
document regarding KGB Active Measures was released in full and further noted that it was from a foreign
government that specifically requested not to be identified.

Canadian

(S) A report received through Canadian liaison channels on West-East defectors (Martin and
Mitchell) is in the collection. As consultations with the Canadian desk were underway, the BOARD
determined the document as not believed relevant and postponed its release until 2017.

Dutch

: (S) The BOARD wanted to release two attachments (teltap transcripts) to a dispatch from the
Dutch Station. The matter was coordinated with the Dutch desk, the Dutch Station, and the Director
General of the Dutch National Security Service. As a result, translation substitutions provide the

| information from intercepted conversations on the topics of “Mr. Lee (sic)” and Richard Gibson, but

redactions obscure the source of the transcripts, according to guidelines in.a letter from the service. Release

of the redacted portions is postponed until 2017.
